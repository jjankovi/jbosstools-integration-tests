...
public class AsYouTypeValidationUtil {
	...
	public static boolean markerExists(IAnnotationModel annotationModel) {
		return markerExists(annotationModel, null, null);
	}
	
	public static boolean markerExists(String type, String message) {
		return markerExists(getAnnotationModel(), type, message);
	}
	
	public static boolean markerExists(IAnnotationModel annotationModel, String type, String message) {
